...
export function setTable(
	...
	res.locals.table = "Itineraries";
	next();
}
/**
 * Retrieves itineraries from the database based on query parameters and sends the result in the response.
...
/**
 * Inserts itineraries into the database based on the request body and sends the result in the response.
...
/**
 * Updates itineraries in the database based on the request body and sends the result in the response.
...
/**
 * Deletes itineraries from the database based on the request body and sends the result in the response.
