...
export function generateSelectQuery(
	params: DatabasesTypes.SimpleSelectParamsType
): string {
...
export function generateInsertQuery(
	params: DatabasesTypes.InsertParamType
): string {
...
export function generateUpdateQuery(
	params: DatabasesTypes.UpdateParamsType
): string {
...
export function generateDeleteQuery(
	params: DatabasesTypes.SimpleDeleteParamsType
): string {
...
export function prepareInsertParms(map: DatabasesTypes.MapListParam): {
	columns_text: string;
	values_text: string;
	values: any[];
} {
...
export function prepareUpdateParams(map: DatabasesTypes.MapListParam): string {
	let assignment = "";
	map.forEach((record) => {
